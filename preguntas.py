...
def pregunta_01():
    ...
    df_tagged = df[df["lbl"].notnull()] ;  df_untagged = df[df["lbl"].isnull()]
    x_tagged =df_tagged["msg"]  ;  y_tagged =df_tagged["lbl"]
    x_untagged = df_untagged["msg"] ;   y_untagged = df_untagged["lbl"]
...
def pregunta_02():
    ...
    x_tagged, y_tagged, useless, useless2 = pregunta_01()
...
def pregunta_04():
    ...
    # BernoulliNB.
    param_grid = {
        "Bernoulli__alpha": np.linspace(0.1, 1, 10),
    }
